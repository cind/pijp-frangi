...
class Stage(Commands):
    ...
    def make_wmhmask(self,t1,input_flair):
        ...
        wmh_cmd = f"\"addpath('/opt/mathworks/MatlabToolkits/spm12_r7219');addpath('/opt/mathworks/MatlabToolkits/LST/3.0.0');spm_jobman('initcfg');ps_LST_lpa({unzipped_flair});exit\""
        matlab_cmd = f'-nodesktop -noFigureWindows -nosplash -r {wmh_cmd}'
        print(matlab_cmd)
        #print(self.matlab(matlab_cmd))
